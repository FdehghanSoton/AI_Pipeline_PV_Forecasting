"""Compact main-text results figure.

One figure summarising the held-out forecast quality: a daylight scatter with
on-figure R2 and nRMSE, and a representative held-out week with missing
measurements shown as gaps rather than as zeros. All values are read from the
saved V4 outputs, so the figure cannot drift from the reported metrics.
...
def main() -> None:
    ...
    fig, (ax_scatter, ax_week) = plt.subplots(1, 2, figsize=(7.2, 3.2))
